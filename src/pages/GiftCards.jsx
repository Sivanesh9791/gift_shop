...
export default function GiftCards() {
  ...
  useEffect(() => {
    document.title = "Gift Cards | TRESOR GIFTS";
  }, []);
  ...
  const handleAddToCart = () => {
    ...
    const giftCardProduct = {
      ...
      name: `TRESOR GIFTS ${deliveryType === 'physical' ? 'Physical' : 'eGift'} Card`,
    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="bg-slate-900 text-white py-16 px-4 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <p className="text-slate-300 text-lg max-w-xl mx-auto">They know what they want. Let them choose from hundreds of personalized gifts with a TRESOR GIFTS gift card.</p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 mt-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-200">
          ...
          <section className="mb-10">
            ...
            <div className="flex flex-wrap gap-3">
              {DENOMINATIONS.map(val => (
                <button
                  ...
                  className={`w-20 h-14 rounded-xl font-bold text-lg transition-all ${!isCustom && amount === val ? 'bg-red-600 text-white shadow-md ring-2 ring-red-200 ring-offset-2' : 'bg-slate-50 text-slate-700 border border-slate-200 hover:border-red-300 hover:bg-red-50'}`}
                >
                  ${val}
                </button>
              ))}
              <div className={`relative flex-grow sm:flex-grow-0 min-w-[140px] h-14 rounded-xl border transition-all ${isCustom ? 'border-red-600 ring-2 ring-red-200 ring-offset-2 bg-white' : 'border-slate-200 bg-slate-50'}`}>
            ...
            {isCustom && (activeAmount < 5 || activeAmount > 500) && (
              <p className="text-red-600 text-xs font-bold mt-2">Custom amount must be between $5 and $500.</p>
            )}
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3">
              <label className={`flex items-center gap-4 p-4 rounded-xl border cursor-pointer transition-all ${deliveryType === 'email' ? 'border-red-600 bg-red-50' : 'border-slate-200 hover:bg-slate-50'}`}>
                <input type="radio" checked={deliveryType === 'email'} onChange={() => setDeliveryType('email')} className="text-red-600 focus:ring-red-500 w-4 h-4 cursor-pointer" />
                <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-red-600 shadow-sm"><Mail size={18} /></div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full border border-slate-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-red-500 outline-none"
                />
              </div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full border border-slate-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-red-500 outline-none resize-none"
                ></textarea>
        ...
        <div className="lg:sticky lg:top-24 space-y-6">
          ...
          {/* Card Visual Mockup */}
          <div className="aspect-[1.586/1] bg-gradient-to-br from-red-600 via-red-800 to-black rounded-2xl shadow-xl p-6 md:p-8 text-white relative overflow-hidden flex flex-col justify-between">
            {/* Shapes */}
            ...
            <div className="flex justify-between items-start relative z-10">
              <span className="font-serif text-2xl md:text-3xl font-bold tracking-tight">TRESOR GIFTS</span>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <button 
              ...
              className="w-full sm:w-auto bg-slate-900 text-white font-bold py-3.5 px-8 rounded-xl flex items-center justify-center gap-2 hover:bg-red-700 shadow-md transition-colors active:scale-95"
            >
