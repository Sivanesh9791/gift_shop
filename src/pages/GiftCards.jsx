...
export default function GiftCards() {
  ...
  const handleAddToCart = () => {
    ...
    const giftCardProduct = {
      ...
      name: `IndianBliss Giftzz ${deliveryType === 'physical' ? 'Physical' : 'eGift'} Card`,
    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="bg-slate-900 text-white py-16 px-4 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <p className="text-slate-300 text-lg max-w-xl mx-auto">They know what they want. Let them choose from hundreds of personalized gifts with an IndianBliss Giftzz gift card.</p>
        </div>
      </div>
        ...
        <div className="lg:sticky lg:top-24 space-y-6">
          ...
          <div className="aspect-[1.586/1] bg-gradient-to-br from-rose-500 via-pink-500 to-amber-500 rounded-2xl shadow-xl p-6 md:p-8 text-white relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="flex justify-between items-start relative z-10">
              <span className="font-serif text-2xl md:text-3xl font-bold tracking-tight">IndianBliss Giftzz</span>
