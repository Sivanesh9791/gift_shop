...
export default function Dashboard() {
 ...
 <button className="px-3 py-1 text-xs font-medium bg-red-600 text-white rounded-lg">
 Week
 </button>
 <button className="px-3 py-1 text-xs font-medium text-[#6B7280] hover:bg-gray-100 rounded-lg">
 Month
 </button>
 </div>
 </div>
 ...
 <div className="px-6 py-4 border-b border-[#E4E4E7] flex justify-between items-center">
 <h3 className="text-lg font-bold text-[#111111]">
 Recent Orders
 </h3>
 <button
 ...
 <div
 key={index}
 className="flex justify-between items-center py-3 border-b border-[#E4E4E7] last:border-b-0"
 >
 ...
 className="mt-4 w-full text-center text-red-600 hover:text-red-700 text-sm font-medium"
 >
 View All Products → {' '}
 </button>
 </div>
 ...
 <button
 onClick={() => navigate('/admin/products')}
 className="bg-red-600 hover:opacity-90 text-white rounded-xl p-4 text-center transition-opacity"
 >
