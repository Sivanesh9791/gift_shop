...
export default function Products() {
 ...
 {/* FILTERS */}
 <div className="flex flex-wrap gap-3 mb-6 bg-white border border-[#E4E4E7] p-4 rounded-xl">
 ...
 className="w-full bg-[#F4F4F5] text-[#111111] placeholder-gray-500  rounded-lg px-4 py-2 pl-10 text-sm focus:outline-none focus:ring-2 focus:ring-red-500"
 />
 </div>
 ...
 className="bg-[#F4F4F5] text-[#111111] rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500"
 >
 ...
 <div className="text-sm text-[#6B7280] px-2 py-2">
 ...
 {/* BULK ACTIONS BAR */}
 {selectedIds.size > 0 && (
 <div className="flex items-center gap-4 bg-blue-50 p-4 rounded-xl border border-blue-200 ">
 <span className="text-sm font-medium text-blue-600 ">
 {selectedIds.size} products selected
 </span>
 <button
 onClick={deleteSelected}
 className="text-sm font-medium text-red-600 hover:text-red-700 px-3 py-1 bg-red-50 rounded-lg"
 >
 Delete Selected
 </button>
 </div>
 ...
 <th className="px-6 py-3 text-left text-xs font-semibold text-[#6B7280]">Image</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-[#6B7280]">Name & Category</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-[#6B7280]">Price</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-[#6B7280]">Stock</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-[#6B7280]">Status</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-[#6B7280]">Rating</th>
 ...
 return (
 <tr key={product.id} className="border-b border-[#E4E4E7] hover:bg-gray-50 transition-colors duration-150">
 ...
 <td className="px-6 py-4">
 <div className="text-sm font-medium text-[#111111] truncate max-w-xs">
 {product.name}
 </div>
 <span className="text-xs px-2 py-1 bg-red-100 text-red-700 rounded inline-block mt-1">
 {product.category}
 </span>
 ...
 <span className="text-sm font-medium text-[#111111]">{product.rating}</span>
 ...
 className="flex items-center gap-1 px-3 py-2 text-sm font-medium text-[#6B7280] hover:bg-gray-100 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 <Dialog.Panel className="relative bg-white border border-[#E4E4E7] rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-xl">
 {/* Header */}
 <div className="sticky top-0 flex items-center justify-between bg-[#F4F4F5] p-6 border-b border-[#E4E4E7]">
 <Dialog.Title className="text-xl font-bold text-[#111111]">
 ...
 className="w-full mt-1 px-4 py-2 bg-[#F4F4F5] text-[#111111] rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
 />
 </div>

 <div>
 <label className="text-sm font-medium text-[#111111]">Slug</label>
 <input
 type="text"
 name="slug"
 value={formData.slug}
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Sub Category</label>
 <input
 type="text"
 name="subCategory"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Short Description</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Delivery Days</label>
 <input
 type="number"
 name="deliveryDays"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Weight</label>
 <input
 type="text"
 name="weight"
 ...
 <div className="space-y-4">
 <div>
 <label className="text-sm font-medium text-[#111111]">Image 1 *</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Image 2</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Image 3</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Image 4</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Recipient</label>
 <select
 name="recipient"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Rating</label>
 <input
 type="number"
 name="rating"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Review Count</label>
 <input
 type="number"
 name="reviewCount"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Stock Count</label>
 <input
 type="number"
 name="stockCount"
 ...
 <div>
 <label className="text-sm font-medium text-[#111111] mb-2 block">Occasions</label>
 <div className="max-h-32 overflow-y-auto bg-[#F4F4F5] rounded-lg p-2 space-y-2">
 ...
 className="rounded"
 />
 <span className="text-sm text-[#111111]">{occasion}</span>
 </label>
 ))}
 </div>
 </div>
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Tags (comma-separated)</label>
 <input
 type="text"
 name="tags"
 value={formData.tags}
 ...
 {/* TOGGLES */}
 <div className="space-y-3 pt-6 border-t border-[#E4E4E7]">
 ...
 formData[toggle.field] ? 'bg-red-600' : 'bg-gray-300'
 }`}
 >
 <span
 ...
 <span className="text-sm font-medium text-[#111111]">{toggle.label}</span>
 </div>
 ))}
 </div>
 ...
 <div>
 <label className="text-sm font-medium text-[#111111]">Personalisation Note</label>
 <input
 type="text"
 ...
 {/* Footer */}
 <div className="sticky bottom-0 flex gap-3 bg-[#F4F4F5] p-6 border-t border-[#E4E4E7]">
 <button
 onClick={closeModal}
 className="flex-1 px-4 py-2 text-[#111111] border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors font-medium"
 >
 Cancel
 </button>
 <button
 ...
 <Dialog.Panel className="relative bg-white border border-[#E4E4E7] rounded-2xl w-full max-w-sm shadow-xl">
 <div className="p-6">
 ...
 <div>
 <Dialog.Title className="text-lg font-bold text-[#111111]">Delete Product?</Dialog.Title>
 {deletingProduct && (
